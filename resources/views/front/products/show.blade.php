				...
				<div class="col-lg-10 col-md-12 col-lg-offset-1">
					...
					<div class="ps-product__thumbnail--mobile">
						...
						<div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
							...
							<img src="{{ $product->image_url }}" alt=""><img src="{{ $product->image_url }}" alt=""><img
					...
					<div class="ps-product__info">
						...
						<p class="ps-product__category"><a
								href="{{ route('categories.view', $product->category_id) }}">{{ $product->category->name }}</a></p>
						...
						<form action="{{ route('cart') }}" method="POST" id="fromCart">
							@csrf
							...
							<div class="ps-product__shopping">
								<a class="ps-btn mb-10" href="javascript:;" onclick="document.getElementById('fromCart').submit()">Add to cart<i class="ps-icon-next"></i></a>
							...
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
											class="ps-icon-heart"></i></a><img src="{{ $product->image_url }}" alt=""><a class="ps-shoe__overlay"
										href="{{ route('products.view', $product->slug) }}"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
										<div class="ps-shoe__variant normal"><img src="{{ $product->image_url }}" alt=""><img
												src="{{ $product->image_url }}" alt=""><img src="{{ $product->image_url }}" alt=""><img
												src="{{ $product->image_url }}" alt=""></div>
									...
									<div class="ps-shoe__detail"><a class="ps-shoe__name"
											href="{{ route('products.view', $product->slug) }}">{{ $product->name }}</a>
